    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-actions>
            ...
            <v-btn
                    ...
                    color="deep-purple lighten-2"
                    text
                    @click="openSelectFood"
            >
                SelectFood
            </v-btn>
            <v-dialog v-model="selectFoodDiagram" width="500">
                <SelectFoodCommand
                        @closeDialog="closeSelectFood"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async selectFood(params) {
                try {
                    if(!this.offline) {
                        var temp = await axios.put(axios.fixUrl(this.value._links['select-food'].href), params)
            ...
            openSelectFood() {
                this.selectFoodDiagram = true;
            },
            closeSelectFood() {
                this.selectFoodDiagram = false;
            },
            async orderCancel() {
                try {
                    if(!this.offline) {
